...
$consulta=$mysqli->query("INSERT INTO legalizaciones (numero,serie,factura,ano,circunscripcion,funcionario,fecha,legalizador,idpais,idprovincia,tipodoc,titulardoc,anulado,nombreApellido,intervencion,arancelconsular,importe)
