    ...
    <ul class="nav">
      ...
      <li><a href="inicio.php">Funciones</a>
        <ul>
          ...
          <li><a href="listarFuncionario.php">Listar Funcionario</a></li>
          <li><a href="agregarFuncionario.php">Crear Funcionario</a></li>
          <li><a href="excelTotal.php">Excel TOTAL</a></li>
