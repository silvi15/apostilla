...
<div id="div-regForm">
  <form action="listarHabilitacionFecha.php" method="post" >
  <h1>Buscar Habilitaciones por fechas</h1><p>
...
$consult=$mysqli->query("SELECT * FROM  habilitaciones where intervencion = 'Habilitacion' AND fecha BETWEEN  '$fechaInicio' AND '$hoy' ORDER BY id DESC ");
