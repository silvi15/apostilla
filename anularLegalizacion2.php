...
?>
<a href="listarLegalizacion.php">Volver</a><br><br>
<form name="informe" action="listarLegalizacion.php" method="get">
<p class="informe">
<?php
echo "ID: $idLega <br>";
...
<?php
$consulta=$mysqli->query("UPDATE legalizaciones SET anulado='1' ,intervencion='$intervencion',idautoridad='$idautoridad' , numero='$numero',serie='$serie',
...
if($consulta>0){
	echo"<br>la Legalización fue Anulada con exito";

}else{
	echo"Error la Legalización no fue Anulada";
}
