...
$idHabilitacionNuevo =$_GET['idHabilitacionNuevo'];

$seleccion = $mysqli->query("SELECT * FROM habilitaciones WHERE numero = '$numero' and serie='$serie' and id='$idHabilitacionNuevo' ");
...
<h3>
  <div id='tituloH'>
    <strong>Direccion General de Asuntos Consulares<strong></p>
      <br><br>
      <a href="crearHabilitacion.php"><strong>HABILITADO</strong></a>
      <br><br><br><br>
    </div>
    <div id='cuadro'>
      <?php
      ...
      N° de Orden: $idHabilitacionNuevo/$ano <br>
