...
?>
<form name="informe" action="imprimirApostillaLista.php" method="get">
<p class="informe"><a href="listarApostilla.php">Volver</a>
  <br><br>
  <h3>Apostilla</h3>
<br>
<?php
...
echo "<strong> Numero: </strong> $numero <br>";
...
echo "<strong> legalizador: </strong> $legalizador <br><br>";
