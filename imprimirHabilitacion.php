...
?>
<body>
<form name="contact_form" method="post"action="imprimirHabilitacion2.php" onsubmit="return validate_form ( );">

<p align="left"><strong>Imprimir Habilitación </strong></p><br>
 <!--Intervencion -->
