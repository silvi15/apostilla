...
?>
<a href="listarHabilitacion.php">Volver</a><br><br>
<form name="informe" action="listarHabilitacion.php" method="get">
<p class="informe">
<?php
echo "ID: $idLega <br>";
...
?>
<p>
    <input type="hidden" value="<?php echo $idLega; ?>">
	  <input type="submit" name="imprimir" value="imprimir"> <br>
	</form>

<?php
$consulta=$mysqli->query("UPDATE habilitaciones SET anulado='1' ,intervencion='$intervencion',idautoridad='$idautoridad' , numero='$numero',serie='$serie',
...
if($consulta>0){
	echo"<br>la Habilitación fue Anulada con exito";

}else{
	echo"Error la Habilitación no fue Anulada";
}
