...
?>
<body>
<form name="contact_form" method="post"action="imprimirLegalizacion2.php" onsubmit="return validate_form ( );">

<p align="left"><strong>Imprimir Legalización</strong></p><br><br>
...
<br><br><br>
<input name="buscar" type="submit" value="IMPRIMIR">
