...
<div id="div-regForm">
    <form id="regForm" action="" method="post">
      <table>
        ...
        <a href="listarLegalizacion.php">Listar Por Fecha</a><p>
        <tr>
            </tr>
              <tr>
                <td>id</td>
...
$consult=$mysqli->query("SELECT * FROM legalizaciones where intervencion = 'Legalizacion' AND fecha BETWEEN  '$entrada' AND '$salida' ORDER BY id DESC ");
