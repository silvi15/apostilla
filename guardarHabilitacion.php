...
$consulta=$mysqli->query("INSERT INTO habilitaciones (numero,serie,factura,ano,circunscripcion,funcionario,fecha,legalizador,idpais,idprovincia,tipodoc,titulardoc,anulado,nombreApellido,intervencion,arancelconsular,importe)
	VALUES ('$numero','$serie','$factura','$ano','$circunscripcion','$funcionario','$fecha','$legalizador','$idpais','$idprovincia','$tipodoc','$titulardoc','0','$nombreApellido','$intervencion','$arancelconsular','$importe')") or trigger_error($mysqli->error."[$consulta]");
...
if( $consulta < 0){
	...
	<form name="informe" method="get" action="habilitacion.php">
		<p class="informe">
			<?php
			echo "<strong> ID:        </strong> $idHabilitacionNuevo <br>";
