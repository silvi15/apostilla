...
<body style="font-family: sans-serif">
    ...
    <h3 align="center" >REPORTE DE CANCILLERIA LIBRO</h3>

<form class="reporte" method="post"action="crearLibroApostilla2.php">
    <table>
      <tr>
        <p>
...
<br><br><br>
<form class="reporte" method="post"action="crearLibroLegalizaciones2.php">
    <table>
      <tr>
            <p>
...
<br><br><br>
<form class="reporte" method="post"action="crearLibroHabilitacion2.php">
    <table>
      <tr>  
      <p>
