...
$fechaInicio=("$ano".'/'."$mes".'/'."$dia");
	...
	$consulta = "SELECT * FROM legalizaciones WHERE fecha BETWEEN  '$fechaInicio' AND '$fechaFinInforme' AND intervencion='Legalizacion'";
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->getProperties()->setCreator("Codedrinks") //Autor
							 ...
							 ->setDescription("Reporte de Legalizacion")
							 ->setKeywords("Reporte de Legalizacion")
							 ->setCategory("Reporte excel");

		$tituloReporte = "Reporte de Legalizacion";
		...
		$id=$fila['id'];
        $consulta2=$conexion->query("SELECT * FROM legalizaciones where id = '$id'");
		...
		$objPHPExcel->getActiveSheet()->setTitle('Legalizaciones');
		...
		header('Content-Disposition: attachment;filename="ReportedeLegalizaciones.xlsx"');
